      ...
      <Modal.Body>
        <Form>
          <Form.Group className="mb-3" controlId="formBasicTitle">
            ...
            <Form.Control size="sm" type="text" placeholder="제목을 입력해주세요" onChange={(e) => {setTitle(e.target.value);}}/>
          </Form.Group>
          <Form.Group className="mb-3" controlId="formBasicDescription">
            <Form.Label>간단 설명</Form.Label>
            <Form.Control as="textarea" rows={9} placeholder="장소에 대한 간단한 설명을 입력해주세요" onChange={(e) => {setDescription(e.target.value);}}/>
          </Form.Group>
          ...
          <Button className='photospotCreateBtn' variant="primary" onClick={(e) => {createPhotospot(e);}}>
            생성
          </Button>
        </Form>
      </Modal.Body>
